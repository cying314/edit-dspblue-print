...
| -	x                 | Number                    | 4                           |                                                              |
| -	y                 | Number                    | 4                           |                                                              |
| primaryAreaIdx         | Number                    | 4                           |                                                              |
| numAreas               | -                         | 1                           | areas数组长度（仅读取）                                      |
| areas                  | Array(*numAreas*)         |                             |                                                              |
| -	*_array_item*     | **[AREA](#AREA)**         | 14                          |                                                              |
| numBuildings           | -                         | 4                           | buildings数组长度（仅读取）                                  |
| buildings              | Array(*numBuildings*)     |                             |                                                              |
| -	*_array_item*     | **[BUILDING](#BUILDING)** | 61 + *_parameterLength* * 4 |                                                              |



> <span id="AREA">**AREA对象**</span>
...
> <span id="BUILDING">**BUILDING对象**</span>
...
| parameters         | **[PARAM](#PARAM)** | *parameterLength* * 4 | 建筑配置参数                    |



- <span id="PARAM">**PARAM对象**</span>
