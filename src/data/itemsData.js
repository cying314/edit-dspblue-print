export const items = [
    ...
    { id: 2001, models: [35], name: '传送带', icon: 'belt-1', grid: [2, 2, 1] },
    { id: 2002, models: [36], name: '高速传送带', icon: 'belt-2', grid: [2, 2, 2] },
    { id: 2003, models: [37], name: '极速传送带', icon: 'belt-3', grid: [2, 2, 3] },
    { id: 2011, models: [41], name: '分拣器', icon: 'inserter-1', grid: [2, 3, 1] },
    ...
    { id: 2030, models: [208], name: '流速监测器', icon: 'monitor', grid: [2, 3, 4] },
    ...
    { id: 2211, models: [118], name: '微型聚变发电站', icon: 'fusion-power-station', grid: [2, 1, 9] },
    { id: 2213, models: [255], name: '地热发电站', icon: 'geothermal-power-station', grid: [2, 1, 8] },
    ...
    { id: 2317, models: [64], name: '量子化工厂', icon: 'quantum-chemical-plant', grid: [2, 4, 10] },
    { id: 2205, models: [55], name: '太阳能板', icon: 'solar-panel', grid: [2, 1, 6] },
    { id: 2206, models: [46], name: '蓄电器', icon: 'accumulator', grid: [2, 1, 7] },
    { id: 2207, models: [46], name: '蓄电器（满）', icon: 'accumulator-full', grid: [2, 1, 7] },
    { id: 2311, models: [72], name: '电磁轨道弹射器', icon: 'em-rail-ejector', grid: [2, 3, 11] },
    { id: 2208, models: [73], name: '射线接收站', icon: 'ray-receiver', grid: [2, 1, 11] },
    { id: 2312, models: [74], name: '垂直发射井', icon: 'vertical-launching-silo', grid: [2, 3, 12] },
    { id: 2209, models: [45], name: '能量枢纽', icon: 'energy-exchanger', grid: [2, 1, 10] },
    { id: 2310, models: [69], name: '微型粒子对撞机', icon: 'hadron-collider', grid: [2, 3, 10] },
    { id: 2210, models: [56], name: '人造恒星', icon: 'fusion-reactor', grid: [2, 1, 12] },
    { id: 2107, models: [371], name: '物流配送器', icon: 'logistics-distributor', grid: [2, 2, 9] },
    { id: 2103, models: [49], name: '行星内物流运输站', icon: 'logistic-station', grid: [2, 2, 10] },
